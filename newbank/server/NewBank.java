...
public class NewBank {
	...
	public synchronized String processRequest(CustomerID customer, String request) {
		if(customers.containsKey(customer.getKey())) {
			switch(request) {
				...
				case "Show All Current Balances" : return showallMyBal(customer);
	...
	//Handles retrieving all the current balances.
	private String showallMyBal(CustomerID customer){return (customers.get(customer.getKey())).AllCurrentBalanceToString();}
